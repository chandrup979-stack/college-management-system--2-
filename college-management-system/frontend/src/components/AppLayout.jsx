...
const AppLayout = () => {
  ...
  // De-duplicate by "to" while keeping first occurrence per role list order
  const seen = new Set();
  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      {/* Sidebar */}
      <aside className="w-64 bg-ink-900 text-slate-200 flex flex-col shrink-0">
        <div className="flex items-center gap-2 px-6 py-6 border-b border-white/10">
          <Crest className="text-gold-400" size={26} />
          <div>
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-9 h-9 rounded-full bg-gold-500 text-ink-900 font-semibold flex items-center justify-center text-sm">
              {initials}
            </div>
